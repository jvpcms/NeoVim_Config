...
require("bufferline").setup({
  options = {
    always_show_bufferline = true, -- This ensures bufferline is always visible
    show_tab_indicators = true, -- Show tab indicators at the top
  },
})

-- lualine - for battery plugin
require("lualine").setup({
  sections = {
    -- Keep lualine_c for other components if needed
    -- lualine_c = {
    --   -- other components (center section)
    --   function()
    ...
    lualine_x = {
      -- Add the clock here if it is defined
      -- Function for battery plugin output
      function()
        local battery = require("battery").get_status_line()
        return battery or "Battery info not available"
      end,
